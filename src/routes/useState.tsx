  ...
  return (
    <>
      <div className='grid grid-cols-4 grid-rows-6 items-center justify-center h-[calc(100dvh-64px)] w-[calc(97px*4+12px*3)] text-3xl gap-3 py-4 m-auto font-bold'>
        ...
        <button className='rounded-3xl h-full bg-stone-500/10 hover: cursor-pointer text-emerald-700 hover:text-emerald-600 active:bg-emerald-700 active:text-white col-start-1 row-start-6' onClick={()=>{setCalcScreen(addCharOnCalc(CalcScreen,'0'))}}>0</button>
        ...
        <button className='rounded-3xl h-full bg-stone-500/10 hover: cursor-pointer text-cyan-600 hover:text-cyan-500 active:bg-cyan-600 active:text-white col-start-2 row-start-6' onClick={()=>{setCalcScreen(addCharOnCalc(CalcScreen,','))}}>,</button>
        <button className='rounded-3xl h-full bg-cyan-600 text-white hover:bg-cyan-700 hover:cursor-pointer active:bg-cyan-800 col-start-3 col-end-5 row-start-6' onClick={()=>{setCalcScreen(calcular(CalcScreen))}}>=</button>
      </div>
    </>
  )
}
